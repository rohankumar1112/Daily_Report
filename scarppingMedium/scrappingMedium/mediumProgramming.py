...
website='https://medium.com/tag/programming'
driver.get(website)
...
# Taking help for link extract form https://github.com/ritiksh122/LearnScrapping/blob/main/Medium/main.py
Content=[]
...
df.to_csv('medium_ProgrammingData.csv',index=False)
